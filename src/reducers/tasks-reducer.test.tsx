import {
    addTasksAC ,
    changeTaskStatusAC , removeTasksAC , tasksReducers ,
    TasksStateType , updateNewTodolistAC , updateTaskAC
} from './tasksReducers';
import {v1} from "uuid";
...
test('correct task should be added to correct array' , () => {
    ...
    const action = addTasksAC("todolistId2" , "juce" , v1());
...
test('new array should be added when new todolist is added' , () => {
    ...
    const action = updateNewTodolistAC("new todolist");
